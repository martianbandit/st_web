...
with col1:
    st.text(f"{list0[0]}/{list0[1]}/{list0[2]}")
    st.text(f"{list0[3]}:{list0[4]} 登録")

    st.text('---1号---')
    st.text(f"A : {list1[0]}{v1a[0]}")
    st.text(f"B : {list1[1]}{v1b[0]}")
    st.text(f"C : {list1[2]}{v1c[0]}")

    st.text('---2号---')
    st.text(f"A : {list2[0]}{v2a[0]}")
    st.text(f"B : {list2[1]}{v2b[0]}")
    st.text(f"C : {list2[2]}{v2c[0]}")

    st.text('---3号---')
    st.text(f"A : {list3[0]}{v3a[0]}")
    st.text(f"B : {list3[1]}{v3b[0]}")
    st.text(f"C : {list3[2]}{v3c[0]}")

    st.text('---4号---')
    st.text(f"A : {list4[0]}{v4a[0]}")
    st.text(f"B : {list4[1]}{v4b[0]}")
    st.text(f"C : {list4[2]}{v4c[0]}")

    st.text('---5号---')
    st.text(f"A : {list5[0]}{v5a[0]}")
    st.text(f"B : {list5[1]}{v5b[0]}")
    st.text(f"C : {list5[2]}{v5c[0]}")

    st.text('---6号---')
    st.text(f"A : {list6[0]}{v6a[0]}")
    st.text(f"B : {list6[1]}{v6b[0]}")
    st.text(f"C : {list6[2]}{v6c[0]}")

    st.text('---7号---')
    st.text(f"A : {list7[0]}{v7a[0]}")
    st.text(f"B : {list7[1]}{v7b[0]}")
    st.text(f"C : {list7[2]}{v7c[0]}")

    st.text('---8号---')
    st.text(f"A : {list8[0]}{v8a[0]}")
    st.text(f"B : {list8[1]}{v8b[0]}")
    st.text(f"C : {list8[2]}{v8c[0]}")
    
with col2:
    st.text(f"消費量{consumption_rate}/hとして")
    if hour_later == 0:
